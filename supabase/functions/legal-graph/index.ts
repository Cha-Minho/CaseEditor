...
민사·형사 사건의 형식적인 대립 당사자를 추정하지 않는다. 특히 원문에 대한민국이 피고 또는 사실관계의 행위자로 명시되지 않았다면 대한민국을 parties에 만들지 않는다.
형사사건에서 국가가 공소를 제기했다는 이유만으로 대한민국을 당사자로 만들지 말고, 피고인은 원문에 표시된 실제 피고인으로 둔다. 법원·검사·경찰도 구체적인 사실관계 relation이 있을 때만 parties에 넣는다.
